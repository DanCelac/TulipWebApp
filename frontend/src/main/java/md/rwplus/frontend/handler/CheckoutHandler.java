...
import md.rwplus.backend.model.OrderItem;
...
import md.rwplus.frontend.model.CheckoutModel;
	...
	public CheckoutModel init(String name) throws Exception{
		...
		if(user!=null) {
			...
			for(CartLine cartLine: cartLines) {
				checkoutTotal += cartLine.getTotal(); //the total of product in card line
			}
