...
<div class="container">
	...
	<div class="row">
		...
		<div class="mx-auto col-md-8">   <!-- boot 3  col-md-offset-2  boot 4 = mx-auto -->
             
			<div class="card text-center text-white bg-secondary mb-3"> <!--  bootstrap 3= panel, boot 4 = card -->
	
				<div class="card-header "><h4>Product Management</h4> </div>
				 ...
				 <form class="form-horizontal">
				    ...
				    <div class="form-group">
				       <label class="control-label col-md-4" for="name">Enter Product Name: </label>
				          <div class="col-md-8">
				             <input type="text" name="name" id="name"  class="form-control" placeholder="Product Name" class="form-control"/>
				             <em class="help-block" style="color: #ff0000;">Please enter Product Name !</em>
				          </div>
				    </div>
				     
				     <div class="form-group">
				       <label class="control-label col-md-4" for="description">Enter the description: </label>
				          <div class="col-md-8">
				             <input type="text" name="description" id="description"  class="form-control" placeholder="Description" class="form-control"/>
				             <em class="help-block" style="color: #ff0000;">Please enter the description !</em>
				          </div>
				     </div>
				      ...
				      <div class="form-group">
				          ...
				          <div class="col-md-offset-4 col-md-2 ">
				             <input type="submit" name="submit" id="submit"  class="form-control" value="Submit" class="btn btn-primary"/>
