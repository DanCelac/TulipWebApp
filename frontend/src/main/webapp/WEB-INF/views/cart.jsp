				...
				<tbody>
					...
					<c:forEach items="${cartLines}" var="cartLine">
						...
						<tr>
							<td data-th="Product">
								<div class="row">
									<div class="col-sm-3 hidden-xs">
										<img
											src="${pageContext.request.contextPath}/assets/image/${cartLine.product.code}.jpg"
							...
							<td data-th="Quantity">
								<!-- max 5, pentru ca sa nu poata adauga mai mult de produse de un fel -->
								<input type="number" id="count_${cartLine.id}" min="1" max="100"
								class="form-control text-center"
								value="${cartLine.productCount}"
								oninput="this.value = Math.abs(this.value)"
								
								  > <!-- pentru a ignora semnul minus -->
							</td>
				...
				<tfoot>
					...
					<tr>
						<td><a href="${contextRoot}/show/all/products"
							class="btn btn-warning"><span class="glyphicon glyphicon-chevron-left"></span> Continue Shopping</a></td>
						<td colspan="2" class="hidden-xs"></td>
						
						<td class="hidden-xs text-center"><strong>Total
								${userModel.cart.grandTotal} Lei</strong></td>
